...
public class Course2_1_3Activity extends AppCompatActivity implements OnGoNextPageInterface {
    ...
    private class PagerAdapter extends FragmentStatePagerAdapter {
        ...
        public android.support.v4.app.Fragment getItem(int position) {
            switch (position) {
                case 0:
                    return new Course2_1_3Step0();
                case 1:
                    return new Course2_1_3Step1();
                case 2:
                    return new Course2_1_3Step2();
                case 3:
                    return new Course2_1_3Step3();
                case 4:
                    return new Course2_1_3Step4();
                default:
                    return null;
            }
        }
