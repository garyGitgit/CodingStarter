 ...
 * step 3 : 직접 선언 체험
 */
public class Course1_1_2Step3 extends Fragment implements TabCodingInterface {
    //항상 추가
    View root;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        LinearLayout layout = (LinearLayout) root.findViewById(R.id.fragment_course1_1_2step3);
