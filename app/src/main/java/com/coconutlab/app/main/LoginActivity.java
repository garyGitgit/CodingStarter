...
//        });
        ...
        createNewAccountButton = (Button) findViewById(R.id.newUserButton);
        createNewAccountButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //TODO : finish 를 안해주면 액티비티 스택에 남아있으므로 회원가입창에서 가입하기 누르면 finish 를 해준다
                //finish();
            }
        });
        ...
        //사용자 입력이 올바른 경우
            ...
            userQuery.findInBackground(new FindCallback<ParseUser>() {
                ...
                public void done(List<ParseUser> objects, ParseException e) {
                    ...
                    //TODO : 지금은 로그인 정보 없으면 자동으로 회원가입 하지만 새로운 버전에서는 회원가입 페이지로 따로 빼기
...
//     */
//    //TODO : 왜 email, password 만 넘겨주지? parameter 로 필요한 정보들을 넘겨줘야할 듯
...
//                        Log.e(TAG, user.get("nickname").toString());
//                    }
//                    else{
//                        Log.e(TAG, "nickname is null");
//                    }
//
//                    if(user.get("nickname") != null && user.get("nickname").equals(nickname)){
